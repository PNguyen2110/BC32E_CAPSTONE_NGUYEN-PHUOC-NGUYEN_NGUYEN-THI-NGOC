...
import { getBookResult, useQuanLyNguoiDung } from '../../storeToolKit/quanLyNguoiDung';
...
const BookResult = () => {
  ...
  if(isFetchinginFoUser){
    return <div className='container pt-40'>
      ...
      {
         [...Array(10)].map(e=>{
          return <div className='col-span-1 mt-4' key={Math.floor(Math.random() * 1000000) + 100000}>
        ...
        <div className="container px-5 py-32 mx-auto">
          ...
          <div className="flex flex-wrap -m-2">
            ...
            {inFoUser.thongTinDatVe?.map((ticket)=>{
              return   <div className="p-2 lg:w-1/3 md:w-1/2 w-full" key={ticket.maVe}>
              <div className="h-full flex items-center border-pink-400 border p-4 rounded-lg bg-white">
                ...
                <div className="flex-grow">
                  ...
                  <p> <i className='font-semibold'>Ghế: </i> {ticket.danhSachGhe.map((ghe,index)=>{
                     return <Fragment>
                       <span key={ghe.maGhe} className="text-green-400">[{ghe.tenGhe}] , </span>
                       {(index + 1) % 20 === 0 ? <br /> : ''}
                     </Fragment>
                     })}</p>
                  <p></p>
          ...
          <a className="text-red-500 inline-flex items-center  py-2 px-4 rounded-lg  hover:text-black cursor-pointer bg-purple-200 hover:bg-white" onClick={() => navigate(-1)}>Back to booking page
