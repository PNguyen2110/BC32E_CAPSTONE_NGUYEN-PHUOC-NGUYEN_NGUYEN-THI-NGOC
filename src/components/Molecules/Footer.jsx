...
export const Footer = () => {
  ...
  const arrHeThongRap = _.map(rapList, (heThongRap) =>
  ...
  return (
    <footer
      className="py-6 dark:text-black"
      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-4">
            <p className="pb-1 text-lg font-medium text-center pr-16">
              PARTNER
            </p>
            ...
            <ul>
              <li>
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="hover:dark:text-red-500  text-black "
                >
                  About Us
                </a>
              </li>
